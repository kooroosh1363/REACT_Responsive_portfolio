...
export const portfolio = [
  {
    ...
    p2: "The details are not the details. They make the design.",
    p3: "Good design doesn't date. Bad design does.",
    p4: "Everyday people are not very good designers.",
  ...
  },
  {
    ...
    p2: "This 3 column section can be stacked multiple times stacked.",
    p3: "Provided with the product is this fully functional contact.",
